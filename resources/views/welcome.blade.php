                            ...
                            <div class="form-group">
                                ...
                                <div class="btn-group" data-toggle="buttons">
                                    <label class="btn btn-default">
                                        <input type="radiobutton"> Twitter Bio
                                    </label>
                                    <label class="btn btn-default">
                                        <input type="radiobutton"> Location
                                    </label>
                                    <label class="btn btn-default">
                                        <input type="radiobutton"> Department
                                    </label>
                                </div>
                            </div>
                            <button class="btn btn-primary" type="submit">Generate Writer
                        </form>
                    </div>
                </div>
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <form action="POST">
                            <div class="form-group">
                                ...
                                <div class="btn-group" data-toggle="buttons">
                                    <label class="btn btn-default">
                                        <input type="radiobutton"> Listicle
                                    </label>
                                    <label class="btn btn-default">
                                        <input type="radiobutton"> Long Form
                                    </label>
                                </div>
                            </div>
                            <div class="form-group">
